...
const Hero = ({ setBgClass }) => {
    const letters_a = ["S", "t", "e", "p", "h", "e", "n"];
    const letters_b = ["", "", "", "A", "n", "s", "e", "l", "m"];
        ...
        <header className='hero' role='banner'>
            <div className='branding'>
                <div className='heading'>
                    <div className='pronounce'>Stephen Anselm</div>
                    <h1 className='myName'>
                        <div>
                    ...
                    <div className='pronounce credit'>
                        All photos taken by Stephen Anselm
                    </div>
                </div>
                <div className='me'>
